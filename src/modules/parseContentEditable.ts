export function contentEditableToString(contentEditable: HTMLElement) {
    // COPIED FROM STEPHEN HANEY
    // https://stephenhaney.com/2020/get-contenteditable-plaintext-with-correct-linebreaks/
    let newValue = '', isOnFreshLine = false;
    ...
    // END COPY
    parseChildNodesForValueAndLines(contentEditable.children);
    return newValue;
}
